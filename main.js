import {
  ...
  const clearItems = () => {
    // container.innerHTML = "" bu da olur
  ...
  const createListItem = (id, value) => {
    ...
    //*oluşturduğumuz article etiketinin içerisine html etiketlerini aktardık
    element.innerHTML = `
      <p class="title">&#x2714;${value}</p>
      <div class="btn-container">
          <button type="button"class="edit-btn">
  ...
  // Olay izleyiciler //
  //*forma gönderme olayı ekle ve gönderilme olayında addItem fonksiyonunu calıştırır. //
